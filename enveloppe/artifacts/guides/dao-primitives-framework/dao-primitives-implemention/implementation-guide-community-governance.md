...
1. **Selected Patterns**: Which governance patterns you've chosen to incorporate a. You can select defined patterns from the SuperBenefit Knowledge Garden here [[artifacts/patterns/index|patterns]]
...
See [[notes/dao-primitives/implementation/patterns/dao-patterns/dao-state|dao-state]] for details on implementing state documentation for a community governance structure
