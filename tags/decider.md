...
The decider protocol creates a shared common standard for group decision-making that is designed to support [collaboration](artifacts/primitives-framework/guides/discovery/group-scale/collaboration-scale.md) scale teams to make decisions in a way that:
...
If you are a [collaboration](artifacts/primitives-framework/guides/discovery/group-scale/collaboration-scale.md) scale team that needs to make decisions quickly, then the decider protocol could be a useful practice to implement. 
