...
The [concepts](artifacts/primitives-framework/facilitation/concepts/concepts.md) identifies three fundamental scales at which groups operate within decentralized networks, each with distinct coordination mechanisms and dynamics:
