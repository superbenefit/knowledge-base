...
- **Coordination actions**: Communications, decisions, and agreements that coordinate activity across autonomous teams or [cells](notes/dao-primitives/patterns/collaboration-scale-patterns/cell-working-group.md)
