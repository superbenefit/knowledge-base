...
- **[I.01-impact-yield-fund-concept.md](docs/ics/ccc/docs/I-Fund/I.01-impact-yield-fund-concept.md)** - Overview of the Impact Yield Fund concept, structure, and key components
- **[I.02-meeting-notes.md](docs/ics/ccc/docs/I-Fund/I.02-meeting-notes.md)** - Compilation of meeting notes and discussions related to the fund
- **[I.03-diagrams-and-visuals.md](docs/ics/ccc/docs/I-Fund/I.03-diagrams-and-visuals.md)** - Key diagrams illustrating the fund structure and flows
- **[I.04-project-plan.md](docs/ics/ccc/docs/I-Fund/I.04-project-plan.md)** - Step-by-step plan for developing and implementing the fund
- **[I.05-discussion-paper-outline.md](docs/ics/ccc/docs/I-Fund/I.05-discussion-paper-outline.md)** - Outline for the formal discussion paper to share with potential funders
