...
- **[I.01-impact-yield-fund-concept.md](docs/ics/ccc/archive/v0.2/I-Fund/I.01-impact-yield-fund-concept.md)** - Detailed explanation of the fund concept, structure, and key components
- **[I.03-diagrams-and-visuals.md](docs/ics/ccc/archive/v0.2/I-Fund/I.03-diagrams-and-visuals.md)** - Visual representations of the fund structure and flows
- **[I.04-project-plan.md](docs/ics/ccc/archive/v0.2/I-Fund/I.04-project-plan.md)** - Implementation roadmap and action items
- **[I.05-discussion-paper-outline.md](docs/ics/ccc/archive/v0.2/I-Fund/I.05-discussion-paper-outline.md)** - Structure for formal presentation to funders
- **[I-Fund.md](docs/ics/ccc/archive/v0.2/I-Fund/index.md)** - Comprehensive overview of the fund purpose and design
