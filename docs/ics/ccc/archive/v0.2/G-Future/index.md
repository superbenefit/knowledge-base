...
1. [G.01-scaling-strategy.md](docs/ics/ccc/archive/v0.2/G-Future/G.01-scaling-strategy.md)
   - Guidelines for growing the system over time while maintaining quality and trust

2. [G.02-neighbourhood-networks.md](docs/ics/ccc/archive/v0.2/G-Future/G.02-neighbourhood-networks.md)
   - Neighborhood-specific implementation strategies

3. [G.03-journeyland-integration.md](docs/ics/ccc/archive/v0.2/G-Future/G.03-journeyland-integration.md)
   - Integration with Journeyland community gatherings

4. [G.04-artist-collective-collaboration.md](docs/ics/ccc/archive/v0.2/G-Future/G.04-artist-collective-collaboration.md)
...
7. [G.07-citizen-wallet-integration.md](docs/ics/ccc/archive/v0.2/G-Future/G.07-citizen-wallet-integration.md)
   - Integration strategy for Citizen Wallet as the primary Web3 interface

8. [G.08-maple-stablecoin.md](docs/ics/ccc/archive/v0.2/G-Future/G.08-maple-stablecoin.md)
   - Vision for a Canadian regenerative stablecoin ($MAPLE) for community economics

9. [G.09-reserve-currency-integration.md](docs/ics/ccc/archive/v0.2/G-Future/G.09-reserve-currency-integration.md)
...
11. [G.11-impact-yield-fund.md](docs/ics/ccc/archive/v0.2/G-Future/G.11-impact-yield-fund.md)
...
- [G.08-maple-stablecoin.md](docs/ics/ccc/archive/v0.2/G-Future/G.08-maple-stablecoin.md) - For the Canadian vision
- [G.09-reserve-currency-integration.md](docs/ics/ccc/archive/v0.2/G-Future/G.09-reserve-currency-integration.md) - For implementation guidelines
- [D.04-scaling-with-bread.md](notes/ics/ccc/v0.2/D-Examples/D.04-scaling-with-bread.md) - For practical examples
- [G.11-impact-yield-fund.md](docs/ics/ccc/archive/v0.2/G-Future/G.11-impact-yield-fund.md) - For impact-driven funding systems