...
- Rippleworks - forward studio (meeting)

- knowledge garden setup - just waiting for DNS updates

  - dm rather for nonbinding

- 

## Discussion Topics

- Review the knowledge repo flow 

  - 2 repos in github

    - Knowledge garden. Folks don't need to do anything with it

    - Knowledge base - folks clone to their computer, save it from [github.com](http://github.com) to your computer and open in Obsidian

    - To update a entry in the system click the sync button (the github cat button)

    - There is a publishing interface - if you publish something it will create a pull request with the knowledge garden
