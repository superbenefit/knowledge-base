...
- Community cell catchup 

  - meeting on Wednesday :)

- Square up Code of Conduct plans with what's happening at RPP

  - We decided to set up some simple structure and policies for SuperBenefit. We'll do this collaboratively of the next few weeks and push progress out to the SB community for comment and input. 

  - The plan is for us to work on this collaboratively and have this to not cost a lot but if anyone contributes a significant amount of time they will be able to put in a compensation request based on their contribution. 

  - We will aim to reward folks mostly with SPRB
