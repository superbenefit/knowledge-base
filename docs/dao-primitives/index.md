...
The DAO [Primitives](data/concepts/primitives.md) are a handful of building blocks for designing [decentralized organizations](data/concepts/decentralization.md). They're un-opinionated components that can be combined and configured to create governance and operational systems tailored to specific contexts and needs.

Unlike prescriptive frameworks that dictate how organizations should be structured, the primitives offer maximum flexibility while maintaining coherence and interoperability. They enable experimentation with novel forms of [coordination](data/concepts/coordination.md) that can potentially outperform traditional organizational models.
...
[Groups](data/concepts/groups.md) develop through predictable phases, each with distinct needs and challenges. Understanding these phases helps groups select appropriate tools and practices for their current stage of development.
- **Conversation Phase**
- **Formation Phase**
- **Organisation Phase**
- **Iteration Phase**
...
For decentralized [coordination](data/concepts/coordination.md) to work effectively, all entities in a network need clear interfaces. State documentation creates transparency that enables both internal coherence and external [coordination](data/concepts/coordination.md).
...
### 1. [Framework](docs/dao-primitives/primitives-framework/concepts/index.md)
...
### 2. [Patterns](docs/dao-primitives/implementation/patterns/index.md)
Reusable solutions to common [coordination](data/concepts/coordination.md) challenges, organized by scale:
...
1. Explore the [Conceptual Framework](docs/dao-primitives/primitives-framework/concepts/index.md) to understand the key concepts
2. Review the [Group Facilitation Guide](docs/dao-primitives/primitives-framework/implementation/group-facilitation.md) for a practical approach to applying these concepts
3. Browse the [Pattern Library](docs/dao-primitives/implementation/patterns/index.md) for specific solutions to common challenges
