...
### DAOs as fractal networks of connected [cells](data/resources/patterns/cells.md)
...
- Previous: [Scale and the levers that provide DAOs their power](docs/dao-primitives/articles/Scale and the levers that provide DAOs their power.md)
- Next: [Minimum Viable Permissionless-ness](docs/dao-primitives/articles/Minimum Viable Permissionless-ness.md)
