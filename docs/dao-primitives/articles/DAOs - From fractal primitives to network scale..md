...
### [Scale](data/concepts/scale.md) matters
...
### DAOs as fractal networks of connected [cells](data/concepts/cells.md)
...
- Previous: [Scale and the levers that provide DAOs their power](artifacts/primitives-framework/articles/Scale and the levers that provide DAOs their power.md)
- Next: [Minimum Viable Permissionless-ness](artifacts/primitives-framework/articles/Minimum Viable Permissionless-ness.md)

---

## Related Concepts

- [DAOs](data/concepts/daos.md) - Organizations built from fractal primitives
- [Primitives](data/concepts/primitives.md) - Building blocks that compose at network scale
