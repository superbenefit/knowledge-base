...
## Nucleus Overview
For decentralized coordination using small autonomous [teams](data/concepts/teams.md) to be successful, groups need a mechanism to capture and display a clear articulation of the group's current "state". The nucleus primitive serves this role of capturing and maintaining a group's state. 
...
In early [conversation-phase](docs/dao-primitives/primitives-framework/concepts/group-phase/conversation-phase.md) and [formation-phase](docs/dao-primitives/primitives-framework/concepts/group-phase/formation-phase.md) phases, a team's nucleus may be an informal emerging set of agreements. However as a team becomes established ( through [organization-phase](docs/dao-primitives/primitives-framework/concepts/group-phase/organization-phase.md) and [iteration-phase](docs/dao-primitives/primitives-framework/concepts/group-phase/iteration-phase.md) phases), ideally its nucleus should have several technical qualities:
