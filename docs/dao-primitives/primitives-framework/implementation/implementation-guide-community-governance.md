...
- [Implementation-guide-community-governance](docs/dao-primitives/primitives-framework/implementation/implementation-guide-community-governance.md) (this guide)
...
In this DAO Primitives context, Community governance exists as part of a three-layers governance model that occur at three different [layers of scale](data/concepts/groups.md#groups-at-different-scales):
...
- You're establishing or evolving governance for a decentralized [network](data/concepts/networks.md) or [DAO](data/concepts/daos.md)
- You need governance mechanisms that safeguard [purpose](data/concepts/purpose.md), guide long-term evolution, and enable broad stakeholder participation
...
**Scale Requirements:**
- Your [community](data/concepts/community.md) includes 100s+ members who should have voice in governance
- Stakeholder base is diverse (contributors, users, funders, partners, etc.)
- Not all members participate actively in operations, but major [decisions](data/concepts/decisions.md) benefit from broad input
- Scale has grown beyond what informal consensus or small-group decision-making can handle

**Prerequisites:**
- Clear articulation of [community](data/concepts/community.md) [purpose](data/concepts/purpose.md) and values
...
- **[Coordination](data/concepts/coordination.md) at Scale**: How to make collective decisions as networks grow beyond face-to-face and small group interaction scales
...
3. **[Roles](data/concepts/roles.md)** - which contain and manage specific responsibilities and sets of permissions
...
You may want to or have already created an impact model (or theory of change) to describe the way you want your network to have positive impact on the world. It is not necessary to do this right away, as in the early phases ([conversation and formation phases](data/concepts/groups.md#groups-in-developmental-phases)) of developing a community governance structure these details may still be emerging. But it is recommended to have a clearly articulated impact model as you move into coordination and organization phases. This will ensure that you have a solid coherent and testable foundation to connect your network's purpose to actual measurable change in the world.
...
2. **Reputation-Based Governance**
    ...
    - Key Primitives: [Attestations](data/concepts/attestations.md), contribution tracking, reputation algorithms
...
4. **Council Governance**
    - Description: Selected group with defined [responsibilities](data/concepts/responsibilities.md) and constraints
...
5. **Sortition-Based Governance**
    - Description: Random selection of participants for decision-making [roles](data/concepts/roles.md)
...
- Developing [policies](data/concepts/policies.md) e.g codes of conduct, conflict resolution processes etc
...
1. Implement teams, squads, [Cells](data/concepts/roles.md) and [roles](data/concepts/roles.md) etc to manage ongoing community governance functions
...
3. **[Role](data/concepts/roles.md) Descriptions**: Clear documentation of governance [roles](data/concepts/roles.md) and [responsibilities](data/concepts/responsibilities.md)
4. **Process Maps**: Visual representations of key governance processes
5. **[Policies](data/concepts/policies.md)**: Explicit guidelines governing community behavior
...
See [dao-state](docs/dao-primitives/implementation/patterns/dao-patterns/dao-state.md) for details on implementing state documentation for a community governance structure
...
Implementing governance requires creating specific structures that enable [coordination](data/concepts/coordination.md) and decision-making.
...
3. **Working Groups**
    ...
    - Documented [coordination](data/concepts/coordination.md) with broader governance
    - Appropriate autonomy balanced with accountability
    - DAO primitives framework uses [Cells](data/concepts/roles.md) as a working group primitive
4. **Advisory Councils**
...
3. [Organisation Phase](data/concepts/groups.md#groups-in-developmental-phases)
