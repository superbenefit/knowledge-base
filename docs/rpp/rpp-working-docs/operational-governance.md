...
Operational [governance](data/concepts/governance.md) enables autonomous teams to coordinate effectively around [shared resources](data/concepts/resources.md) and [objectives](data/concepts/goals.md) using [decentralized](data/concepts/decentralization.md) infrastructure and sociocratic principles at the coordination scale.

related to:
- [Community Governance](docs/rpp/rpp-working-docs/community-governance.md)
- Multi-Stakeholder Governance
- [Operational Governance](docs/rpp/rpp-working-docs/operational-governance.md)

This pattern provides a [framework](data/concepts/frameworks.md) for implementing efficient, transparent, and adaptable operational systems that maintain [autonomy](data/concepts/autonomy.md) while ensuring [coordination-scale](docs/dao-primitives/primitives-framework/concepts/group-scale/coordination-scale.md).
