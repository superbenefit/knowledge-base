...
*   **[token-based-governance](docs/rpp/rpp-working-docs/token-based-governance.md)**: Quadratic Voting is often positioned as a direct alternative or remedy to the plutocratic tendencies inherent in the "one token, one vote" model.
