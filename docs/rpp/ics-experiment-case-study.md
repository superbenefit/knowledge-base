...
*ICS experiments with [decentralized](data/concepts/decentralization.md) [governance](data/concepts/governance.md) tools, discovering that communities seek participation in decision-making rather than just new funding mechanisms*
...
- Configured Hats Protocol tree implementing [roles](data/concepts/roles.md) pattern
...
While [blockchain](data/concepts/blockchain.md) creates possibility, social adoption requires integration with existing community rhythms, clear value propositions tied to felt needs, and patient cultivation of new practices alongside familiar ones.
...
*This case study contributes to growing knowledge about practical adoption of [decentralized](data/concepts/decentralization.md) [coordination](data/concepts/coordination.md) patterns for social benefit. We invite readers to adapt these insights for their own contexts and share their experiences to further collective learning.*
...
- [Governance](data/concepts/governance.md) - Decision-making patterns explored
- [Coordination](data/concepts/coordination.md) - Mechanisms tested in practice
- [Community](data/concepts/community.md) - Context for coordination experiments
- [DAO Primitives Framework](docs/dao-primitives/index.md) - Framework applied in experiments
