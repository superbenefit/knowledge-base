...
This case study documents progress through July 2025 in an ongoing experiment exploring Web3 technologies for feminist grant-making. Equality Fund partnered with Women Win and SuperBenefit through the Reimagining Power Project to test whether [blockchain](data/concepts/blockchain.md) could reduce transaction costs and increase accessibility for organizations in politically restricted contexts.
...
Equality Fund, a Canadian women's fund that grew from $500,000 to $20 million in grant-making over three years, operates across 85 countries supporting women's organizations. Their Prepare funding stream manages CAD 7 million, selecting 6-7 [grants](data/concepts/grants.md) from approximately 1,000 applications annually.
...
The systematic discovery process examined five potential Web3 applications, generating a Discovery report. The team found that many possibilities required years of additional development, regulatory barriers limited charity participation, and partner readiness varied significantly. After analysis, they concluded: "while many identified opportunities require further technological maturation, two patterns emerged as immediately viable for experimentation." The focus narrowed to grant disbursement through [peer to peer payments](data/resources/patterns/p2p-payments.md), specifically addressing transaction costs and accessibility barriers.
...
More significant were the conceptual shifts. The assumption that transaction costs were the primary barrier proved incorrect for major organizational transfers. The real challenges emerged at the last mile—political restrictions, local banking limitations, and infrastructure gaps. This finding challenges the blockchain sector's emphasis on cost reduction as the primary value proposition for [peer to peer payments](data/resources/patterns/p2p-payments.md).
...
**[Impact Attestations](data/resources/patterns/impact-attestations.md)** remained conceptually important but practically challenging. The need to track grant outcomes while protecting sensitive information about recipients' work created design challenges that the limited experiment couldn't fully address.
...
_This progress report documents learnings through July 2025 in an ongoing experiment exploring [decentralized](data/concepts/decentralization.md) [coordination](data/concepts/coordination.md) patterns for social benefit. The work continues beyond this documentation period. We invite readers to adapt these insights for their own contexts and share their experiences to further collective learning._
...
- [Power](data/concepts/power.md) - Redistribution through participatory processes
- [Governance](data/concepts/governance.md) - Decision-making in funding contexts
- [Grants](data/concepts/grants.md) - Funding mechanisms experimented with
- [Coordination](data/concepts/coordination.md) - Mechanisms for collective resource allocation
