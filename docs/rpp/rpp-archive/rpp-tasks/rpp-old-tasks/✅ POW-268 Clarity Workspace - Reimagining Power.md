...
- ### Documents
	- **Tag Pages** are used to compile tasks and documents related to particular learning journeys and focus areas. These can be used to record learnings, describe projects or concepts, and help fellow contributors discover relevant information.
		...
		- The main project tag is [reimagining power](archive/clarity/Tags/reimagining%20power.md). Also included are:
			- [reimagine institute](archive/clarity/Tags/reimagine%20institute.md)
			- [equality fund](archive/clarity/Tags/equality%20fund.md)
			- [all in for sport](archive/clarity/Tags/all%20in%20for%20sport.md)
			- [ontario trillium foundation](archive/clarity/Tags/ontario%20trillium%20foundation.md)
