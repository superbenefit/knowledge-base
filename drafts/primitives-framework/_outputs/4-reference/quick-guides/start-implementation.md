...
- [Conversation Phase](../../1-framework-foundation/dimensional-lenses/conversation-phase.md) - Still exploring, no formal structure
- [Formation Phase](../../1-framework-foundation/dimensional-lenses/formation-phase.md) - Basic structure emerging
- [Organization Phase](../../1-framework-foundation/dimensional-lenses/organization-phase.md) - Need formal systems
- [Coordination Phase](../../1-framework-foundation/dimensional-lenses/coordination-phase.md) - Integrating with broader networks
...
Read: [Group Scale Index](../../1-framework-foundation/dimensional-lenses/index.md)
...
1. **[Community Governance](../../2-implementation/primitive-selection/implementation-guide-community-governance.md)**
...
2. **[Operational Governance](../../2-implementation/primitive-selection/implementation-guide-operational-governance.md)**
   - For: Execution-focused teams, project delivery
   - Emphasizes: Cell autonomy, role clarity, task coordination

3. **[Multi-Stakeholder Governance](../../2-implementation/primitive-selection/implementation-guide-multi-stakeholder-governance.md)**
...
- Template: Use [Group State Template](../../2-implementation/mapping/group-state-template.md)

**Map Roles**:
- What specialized functions are needed?
- Who has authority for what decisions?
- How are accountabilities structured?
- Consider: [Roles Overview](../../1-framework-foundation/organizational-elements/roles.md)

**Structure Tasks**:
- What work needs coordination?
- How are contributions tracked?
- What deliverables are expected?
- Consider: [Tasks Overview](../../1-framework-foundation/organizational-elements/tasks.md)
...
**Read**: [DAO Primitives Catalog](../../2-implementation/primitive-selection/dao-primitives-catalog.md)
...
Template: [Group State Template](../../2-implementation/mapping/group-state-template.md)
...
- [Group State Template](../../2-implementation/mapping/group-state-template.md)
- Cell formation checklist
- Governance proposal template
- Role definition template

**Quick References**:
- [Organizational Elements Guide](./organizational-elements-guide.md)
- [DAO Primitives Catalog](../../2-implementation/primitive-selection/dao-primitives-catalog.md)

### Facilitation Support

**For Discovery & Design**:
- [Group Facilitation Guide](../templates/group-facilitation.md)
...
- [Nucleus Pattern](../../2-implementation/mapping/nucleus.md) - Group state tracking
...
Read: [SuperBenefit Services Integration](../integrations/sb-services.md)
...
- **[Framework Index](../../1-framework-foundation/index.md)** - Explore complete framework
