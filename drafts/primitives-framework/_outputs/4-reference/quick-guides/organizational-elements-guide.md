...
**Framework Reference**: [DAOs](../../1-framework-foundation/organizational-elements/daos.md)
...
**Framework Reference**: [Cells](../../1-framework-foundation/organizational-elements/cells.md)
...
**Framework Reference**: [Roles](../../1-framework-foundation/organizational-elements/roles.md)
...
**Framework Reference**: [Tasks](../../1-framework-foundation/organizational-elements/tasks.md)
...
- [Group Phase](../../1-framework-foundation/dimensional-lenses/index.md) - Developmental stages
- [Group Scale](../../1-framework-foundation/dimensional-lenses/index.md) - Size and coordination patterns
- [Group State](../../1-framework-foundation/dimensional-lenses/group-state.md) - Documentation framework

### For Practitioners
See implementation guides for applying these elements:
- [Implementation Guide: Community Governance](../../2-implementation/primitive-selection/implementation-guide-community-governance.md)
- [Implementation Guide: Operational Governance](../../2-implementation/primitive-selection/implementation-guide-operational-governance.md)
- [Implementation Guide: Multi-Stakeholder Governance](../../2-implementation/primitive-selection/implementation-guide-multi-stakeholder-governance.md)
