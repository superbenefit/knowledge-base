...
4.  When you're ready to collaborate, move your file to the appropriate project folder in the `/docs/` directory. This signals that you're ready to share your ideas with the team.
...
*   **Collaboration:** To share your work and collaborate with others, you *must* move your files to the `/docs/` directory.
