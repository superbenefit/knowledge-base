...
- **Impact DAO Focus**: While covering broader DAO landscape, database emphasizes social impact, public goods, and regenerative projects, providing particular depth on DAOs pursuing [community](data/concepts/community.md) benefit beyond financial speculation.
...
- [Roles](data/concepts/roles.md) - Authority and responsibility structures
- Governance - Decision-making frameworks
- [Primitives](data/concepts/primitives.md) - Building blocks for organization
