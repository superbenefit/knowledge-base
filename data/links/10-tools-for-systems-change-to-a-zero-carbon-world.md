...
- **[Power](data/concepts/power.md) & Systems Mapping**: Practical approaches for visualizing system dynamics and power relationships, revealing hidden connections, feedback loops, and leverage points that might otherwise remain invisible to change-makers.

### Practical Applications

These tools can be applied in various contexts to:

- Help [community](data/concepts/community.md) diagnose root causes of sustainability challenges rather than merely addressing symptoms
...
- [Coordination](data/concepts/coordination.md) - Systems change requires coordination
- [Governance](data/concepts/governance.md) - Decision-making for systems transformation
- [DAOs](data/concepts/daos.md) - Organizational forms for collective action
- [Teams](data/concepts/teams.md) - Groups working on systems change
