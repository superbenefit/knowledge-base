...
A comprehensive resource for [decentralized](data/concepts/decentralization.md) organization, featuring a curated collection of handbooks, guides, and toolkits designed for non-hierarchical groups, [social movements](tags/social-movements.md), and open-source projects. It serves as a living document that encourages [collaboration](tags/collaboration.md) and knowledge sharing.
...
- **Living Document**: Open for [community](data/concepts/community.md) contributions, reflecting the decentralized ethos by allowing updates and shared insights.
...
22. [Spotify Agile Model](https://engineering.atspotify.com/2020/03/27/scaling-agile-at-spotify/) – Explanation of their tribe and squad [coordination](data/concepts/coordination.md).
...
- [DAOs](data/concepts/daos.md) - Organizations using these organizing approaches
- [Teams](data/concepts/teams.md) - Small groups coordinating decentrally
