...
"A Pocket Guide to DAO Frameworks" offers a clear, accessible overview of the primary technical infrastructures used to create and govern [Decentralized](data/concepts/decentralization.md) Autonomous Organizations. Written by MoreReese, this guide demystifies the technical landscape by comparing the core frameworks that [power](data/concepts/power.md) most [DAOs](data/concepts/daos.md), highlighting their unique approaches to [governance](data/concepts/governance.md), security, and operational functionality. The guide serves as an orientation for those exploring DAO creation or seeking to understand the technical underpinnings of different governance models.
...
- [Primitives](data/concepts/primitives.md) - Building blocks that DAO frameworks provide
- [Coordination](data/concepts/coordination.md) - Mechanisms enabled by DAO frameworks
- [DAO Primitives Framework](docs/dao-primitives/index.md) - SuperBenefit's approach to DAO design
