...
- Community foundations can use the framework to transform relationships with local organizations, reducing application burdens, increasing [transparency](data/concepts/transparency.md) about allocation decisions, and creating ongoing feedback loops that give grantees real voice in shaping funding practices
...
- [Impact](data/concepts/impact.md) investors can apply trust-based principles even within investment structures, offering patient capital with flexible terms, minimizing extractive reporting requirements, and centering entrepreneur/community leadership over investor control
...
- [Governance](data/concepts/governance.md) - Decision-making in philanthropic contexts
