...
- **Power and Enclosure**: Bollier addresses how powerful interests enclose commons—privatizing shared resources from land to knowledge to culture—requiring active political struggle to defend and expand commons. This [power](data/concepts/power.md)-aware analysis connects historical enclosures to contemporary platform capitalism's extraction of user-generated value.
...
- DAO designers can study commons governance patterns when creating blockchain-based [coordination](data/concepts/coordination.md) systems, learning from centuries of commons practice about participatory decision-making, conflict resolution, and preventing power concentration
