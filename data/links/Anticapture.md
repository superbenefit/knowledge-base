...
Participation in the Evaluate phase spans from **centralized** to **decentralized**. The degree of decentralization is often determined by the transparency of the network’s operations. If the network is organized on a public [blockchain](data/concepts/blockchain.md) and communicates in public, even external agents can participate in evaluating its actions.
...
- [Primitives](data/concepts/primitives.md) - Building blocks for decentralized organization
