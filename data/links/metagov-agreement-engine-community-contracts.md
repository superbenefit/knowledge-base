...
publish: true
type: protocol
source: https://medium.com/metagov/introducing-the-agreement-engine-bf03b6d5c16c
author:
  - Metagov
tags:
  - agreement-engine
...
Metagov's Agreement Engine provides infrastructure for [communities](data/concepts/community.md) to create enforceable [agreements](data/concepts/agreements.md) through programmable contracts that bridge informal norms and rigid smart contracts. Communities often need collective commitments more flexible than immutable [blockchain](data/concepts/blockchain.md) code but more accountable than unenforced social norms—agreements about resource sharing, behavior expectations, [decision-making](data/concepts/decisions.md) processes that require enforceability without eliminating human judgment. The Agreement Engine enables communities to formalize mutual obligations while retaining interpretation flexibility, creating contracts that can be amended through collective processes rather than requiring forks when contexts change. This addresses limitation of both purely social [coordination](data/concepts/coordination.md) and purely technical automation.
...
- [DAOs](data/concepts/daos.md) can implement [governance](data/concepts/governance.md) agreements about decision-making processes that participants commit to follow, making procedural norms enforceable while retaining collective capacity to amend processes
...
- Metagov's Agreement Engine provides infrastructure for the middle ground SuperBenefit navigates between informal coordination and rigid technical automation—demonstrating how coordination [primitives](data/concepts/primitives.md) can enable accountability while preserving human judgment and collective amendment capacity rather than forcing choice between unenforced social norms or immutable code.
