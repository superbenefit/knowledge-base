...
publish: true
type: resource-hub
source: https://feministfinance.net/
author:
...
- **Transforming Not Reforming Finance**: Rather than seeking women's equal participation in extractive finance, the project articulates need for fundamental transformation toward economic systems organized around care, interdependence, and collective flourishing—challenging the premise that existing financial structures can be made equitable through inclusion without addressing their extractive logics.
...
- DAO designers can apply care-centered frameworks when creating tokenomics and [governance](data/concepts/governance.md) systems, questioning whether [coordination](data/concepts/coordination.md) mechanisms reward care work, community-building, and relationship maintenance or only value easily quantifiable outputs while extracting from invisible labor
