...
- **Democratic Mechanism Design**: RxC develops and studies [governance](data/concepts/governance.md) mechanisms like quadratic voting and funding showing how mathematical innovation can serve democratic goals, moving beyond one-person-one-vote or one-dollar-one-vote limitations.
...
- **Data Dignity**: RxC advocates for data as labor deserving compensation and control rather than corporate or state property, showing how reclaiming data sovereignty could redistribute [power](data/concepts/power.md) currently concentrated with tech platforms.
...
- **Research-Practice Integration**: The organization bridges academic mechanism design with practical implementation, creating tools activists and organizers can use while maintaining intellectual rigor.

- **Global Movement**: RxC cultivates international network of chapters and practitioners, showing how democratic transformation requires coordinated action across contexts not isolated experiments.
