...
This article introduces a foundational framework for groups moving from unstructured beginnings to formal [governance](data/concepts/governance.md). It emphasizes the importance of transparent, well-documented decisions to ensure legitimacy and reduce ambiguities that could [impact](data/concepts/impact.md) future operations. It also provides a flexible, platform-independent template to help establish essential governance procedures as a stable starting point.
...
#### [Transparency](data/concepts/transparency.md) for Legitimacy
...
- **Vote-Authorized Person**  
  *Individuals permitted to vote on proposals, like [community](data/concepts/community.md) participants.*
