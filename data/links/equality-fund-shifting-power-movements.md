...
al**: The framework centers power analysis in philanthropy, recognizing that resources always come with power dynamics and that claiming neutrality merely obscures how funding concentrates control with donors while extracting accountability from recipients.
...
- **Redistributing Decision-Making**: Beyond individual grant decisions, the framework explores how to redistribute power over funding priorities, allocation processes, and success metrics—bringing movement actors into [governance](data/concepts/governance.md) roles that shape philanthropic strategy rather than merely receiving predetermined [grants](data/concepts/grants.md).
...
- Individual donors can practice power-shifting through trust-based giving to movement funds led by those experiencing injustice, redistributing not just money but decision-making power about allocation
