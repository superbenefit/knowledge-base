...
**[SuperBenefit DAO](https://www.superbenefit.org/) is convening a [series of conversations](https://superbenefit.mirror.xyz/Bcsl19CZ67amLJY_bee5dUy0DEboZykuMQqw58wGlGI) to explore how the nature of [governance](data/concepts/governance.md) is evolving and its role in accelerating transitions to better futures. We're specifically interested in how [blockchain](data/concepts/blockchain.md) technologies are enabling new thinking and ways of doing, and their potential to combine with existing practices, perspectives, and wisdom.**
...
Conversely, the edges of [DAOs](data/concepts/daos.md) are blurred, dynamic, and porous. In many respects, DAOs have no boundaries and are only held together by the gravity of their members' interests, agreements, and beliefs at any point in time. They are organic, fluid, and, essentially, human (_DAO = [Decentralized](data/concepts/decentralization.md) Autonomous ~~Organisation~~ Organism)._ This is also why many of them will flourish and then fall apart.

It follows that while tools and tokens may provide the interstitial fluid within and between these organisms, the human aspects of purpose, identity, and values are more likely to determine both the success and sustainability of any inter-organism [coordination](data/concepts/coordination.md). So, although technology has enabled DAOs to emerge, it may well be the nature of the relational ties and infrastructures that enables them to evolve and thrive.

How this relates to the interplay between digital spaces and physical contexts may also be an area ripe for further exploration (_might digital technologies enhance, and be enhanced by, [networks](data/concepts/networks.md) and systems with existing social capital?_). Indeed, this is an inquiry likely to feature in our next and final conversation of the series - _'New and Old'_.
...
- [@stefdelev](https://twitter.com/stefdelev):
    ...
    - Enables us to explore how we create networks and ecosystems of [community](data/concepts/community.md) versus siloed structures and systems
...
- [@chaserchapman](https://twitter.com/chaserchapman):
    - Models where you can 'rage quit' your funds from the [treasury](data/concepts/treasury.md), but an extreme measure
...
- [Governance for better futures - Meta-governance](/data/links/governance-for-better-futures/Governance%20for%20better%20futures%20-%20Meta-governance.md)
...
- [Governance](data/concepts/governance.md) - Decision-making across DAOs
- [DAOs](data/concepts/daos.md) - Organizations cooperating with each other
- [Coordination](data/concepts/coordination.md) - Mechanisms for inter-DAO collaboration
- [Networks](data/concepts/networks.md) - Structures enabling DAO-to-DAO cooperation
