...
- **Democratic Infrastructure**: Creating tools for community self-[governance](data/concepts/governance.md) and resource management
...
- [Localism](data/concepts/localism.md) - The resource expands on local organization while connecting to global systems
- [Cosmolocalism](data/concepts/cosmolocalism.md) - Exemplifies the "light is global, heavy is local" principle
- [Blockchain](data/concepts/blockchain.md) - Demonstrates practical applications of blockchain for community empowerment
