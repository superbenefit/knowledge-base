...
- Rockefeller's emphasis on power as central to transformation resonates with SuperBenefit's power-aware approach to [coordination](data/concepts/coordination.md) primitives, showing that effective tools must address power dynamics rather than assuming technical mechanisms alone redistribute authority—suggesting that DAO [governance](data/concepts/governance.md) requires explicit power analysis and redistribution design not just decentralized voting.
