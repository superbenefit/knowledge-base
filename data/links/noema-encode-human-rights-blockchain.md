...
Nathan Schneider's provocative essay examines how [blockchain](data/concepts/blockchain.md) protocols could encode human rights protections rather than treating "censorship resistance" and "immutability" as sole values. While crypto evangelizes freedom from control, Schneider shows how this enables both liberation and atrocity—protocols that resist censorship equally serve human rights defenders and human traffickers. The essay explores how rights could be embedded in protocols themselves through mechanisms enabling intervention against genocide, environmental destruction, or exploitation without requiring state enforcement. This challenges assumptions that blockchains must be purely "neutral" showing how protocol design always embodies values—the question is whose values and through what [governance](data/concepts/governance.md).
...
- **Governance for Rights**: Schneider examines what governance would enable rights enforcement without recreating problems of state sovereignty—from [decentralized](data/concepts/decentralization.md) tribunals to [community](data/concepts/community.md)-based verification to graduated intervention capabilities.
...
- **Speculative but Rigorous**: Schneider offers speculative vision grounded in understanding of protocol capabilities and limitations, avoiding both dismissive skepticism and utopian naivety about what blockchain mechanisms can achieve.

### Practical Applications

This vision enables rights-aware protocol development:
...
- Human rights advocates can engage blockchain development, bringing rights frameworks to inform protocol design rather than leaving values embedded in code to crypto-libertarian defaults

- Policy makers can consider how blockchain rights protections might complement or challenge state-based enforcement, understanding new mechanisms as alternative layer rather than replacement for existing international law

### Connection With SuperBenefit

- Schneider's challenge to blockchain neutrality resonates with SuperBenefit's power-aware approach, showing that protocol design always embodies values—the question is whose values and through what governance—suggesting that [coordination](data/concepts/coordination.md) primitives should intentionally encode regenerative commitments rather than claiming neutrality that effectively prioritizes freedom from accountability.
