...
This guide provides practical implementation guidance for **[Poetic Harvesting](data/resources/patterns/poetic-harvesting.md)** - the practice of acting as sacred witness to collective conversations and reflecting wisdom back through spoken word poetry.

For a full understanding of what poetic harvesting is and when to use it, see the **[Poetic Harvesting Pattern](data/resources/patterns/poetic-harvesting.md)**. This guide focuses on the practical how-to for organizations and communities ready to implement this practice.
...
*For the full conceptual framework and background on poetic harvesting, see the **[Poetic Harvesting Pattern](data/resources/patterns/poetic-harvesting.md)**.*
---
...
- [Community](data/concepts/community.md) - Groups engaging in harvest practices
- [Coordination](data/concepts/coordination.md) - Mechanisms for collective reflection
