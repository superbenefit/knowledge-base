...
In a blockchain network, identical copies of a database are stored on multiple computers, resulting in a single, shared ledger that records the history of interactions and asset ownership in the network, and maintains the rules governing interactions. This distributed structure leads to a lot of discussion about the extent and value of [decentralization](data/concepts/decentralization.md), but beware the hype: decentralization could refer to many different things, like the distribution of hardware, software, or [decision-making](data/concepts/decisions.md) [power](data/concepts/power.md). Distributed computing power is not the same as distributed political power. 
...
As well as managing information, blockchains can issue their own "cryptocurrencies" (eg. bitcoin on the Bitcoin network, or ether on the Ethereum network) that enable peer-to-peer value transfers and are used to reward participants for helping maintain the blockchain ledger. To maintain agreement about the "true" state of the shared ledger without a centralized authority, blockchains use a "[consensus](data/concepts/consensus.md) mechanism" that combines cryptography with game-theoretic incentives (eg. payments or penalties paid in cryptocurrencies) in ways that maximize confidence in the integrity of the ledger. 
...
Information management is a critical part of modern societies. Since blockchains enable a wider degree of [participation](data/concepts/participation.md) in the design and management of computer networks (relative to typical modern systems), and since cryptocurrencies can be programed to incentivize specific kinds of cooperative behavior, blockchain networks expand the scope to build sophisticated, large scale networks outside of traditional structures. For example, they make it possible to build transnational networks that are difficult, though not impossible, for governments to control, because states tend to assert regulatory authority via centralized bureaucracies or trusted intermediaries.
---

## Related Concepts

- [DAOs](data/concepts/daos.md) - Organizations using blockchain
- [Primitives](data/concepts/primitives.md) - Blockchain provides organizational primitives
- [DeFi](data/concepts/defi.md) - Decentralized finance on blockchains
- [Governance](data/concepts/governance.md) - Blockchain-based governance systems
- [Transparency](data/concepts/transparency.md) - Transparency enabled by blockchains