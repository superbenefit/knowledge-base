...
_Non-Fungible Tokens (NFTs) are unique, indivisible digital assets recorded on a [blockchain](data/concepts/blockchain.md) that enable verifiable ownership and provenance of digital or physical items, creating new possibilities for representation, [governance](data/concepts/governance.md), and value exchange in [decentralized](data/concepts/decentralization.md) systems._
...
- [blockchain](data/concepts/blockchain.md): The underlying distributed ledger technology that enables NFT verification and tracking
- [governance](data/concepts/governance.md): How NFTs can be used as instruments for participation and collective decision-making
- [primitives](data/concepts/primitives.md): NFTs function as fundamental building blocks for more complex decentralized systems
- [resources](data/concepts/resources.md): NFTs can represent and help manage collective resources in decentralized contexts
- [attestations](data/concepts/attestations.md): Verified claims that can be represented or enhanced through NFT mechanisms
- [payments](data/concepts/payments.md): NFT transfers can trigger or represent value exchanges beyond simple cryptocurrency transactions
- [community](data/concepts/community.md): How NFTs enable new forms of belonging, contribution, and collective organization