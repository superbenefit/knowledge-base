...
- **[Sustainability](data/concepts/sustainability.md)**: The foundation upon which regeneration builds, focusing on maintaining rather than enhancing systems
- **ReFi**: The application of regenerative principles to financial systems using Web3 technologies
- **[Systems](data/concepts/systems.md)**: The holistic perspective necessary for effective regenerative design and practice
- **[Community](data/concepts/community.md)**: A primary scale and context for regenerative development
- **[Purpose](data/concepts/purpose.md)**: The guiding direction that informs regenerative interventions
- **[Localism](data/concepts/localism.md)**: The emphasis on place-based solutions central to many regenerative approaches
- **[Cosmolocalism](data/concepts/cosmolocalism.md)**: The balancing of local regeneration with global knowledge sharing
