...
protocols: 
---
# Participatory [Governance](data/concepts/governance.md)

_A pattern for involving affected [community](data/concepts/community.md) in decisions about resources and initiatives that impact their lives_
...
Participatory governance must navigate diverse cultural contexts around decision-making. Some communities emphasize [consensus](data/concepts/consensus.md) while others use majority voting. Elder councils may hold authority in certain contexts while youth leadership emerges in others. Gender dynamics affect who speaks in mixed gatherings. Implementation must respect and work within cultural frameworks rather than imposing uniform processes.
...
- **Coordi-nations**: Network approaches to participatory [coordination](data/concepts/coordination.md)
