...
This form of solidarity emerges through shared experiences of struggle, educational processes that build common analysis, and collective actions that demonstrate shared commitment. It can develop within [community](data/concepts/community.md) directly affected by specific conditions or extend to include allies who act in support despite not sharing the same direct experiences. This distinction between solidarity within affected groups and solidarity across different positionalities represents an important dimension of movement strategy, requiring intentional practices to navigate power differences while maintaining unified action.

### Solidarity in [Decentralized](data/concepts/decentralization.md) Networks and Web3

Within Web3 ecosystems, solidarity manifests through decentralized [coordination](data/concepts/coordination.md) systems that align individual [participation](data/concepts/participation.md) with collective outcomes. These systems create mechanisms for resource pooling, risk distribution, and collective [governance](data/concepts/governance.md) without requiring centralized control or homogeneity among participants.

[Blockchain](data/concepts/blockchain.md)-based technologies enable new expressions of solidarity by reducing coordination costs, increasing [transparency](data/concepts/transparency.md) in resource flows, and enabling participatory governance across geographic boundaries. Decentralized Autonomous Organizations ([DAOs](data/concepts/daos.md)) represent one implementation of technological solidarity, creating structures where individuals can coordinate action, pool resources, and govern commons through mechanisms that distribute both [decision-making](data/concepts/decisions.md) power and responsibility across networks rather than concentrating them in centralized entities.
...
- **[Mutual Aid](data/concepts/mutual-aid.md)**: Solidarity provides the ethical foundation for mutual aid practices, which embody solidarity through direct reciprocal support
- **[Community](data/concepts/community.md)**: Solidarity creates bonds that strengthen community cohesion and capacity for collective action
- **[Coordination](data/concepts/coordination.md)**: Solidarity enables effective coordination by aligning individual and collective interests
- **[Autonomy](data/concepts/autonomy.md)**: Solidarity balances collective action with respect for individual and group autonomy
- **[Decentralization](data/concepts/decentralization.md)**: Solidarity in decentralized contexts creates resilient networks without centralized control
- **[Values](data/concepts/values.md)**: Solidarity functions as both a value that guides action and a practice that embodies values
