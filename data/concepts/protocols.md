...
Unlike traditional software systems, the open and permissionless nature of blockchain protocols enables global networks of participants to coordinate without central authorities. As noted in the [Minimum Viable Permissionless-ness](../docs/dao-primitives/articles/Minimum Viable Permissionless-ness.md) article, these systems create "the ability for anyone anywhere to contribute creatively to a system" by establishing clear rules that maintain network integrity while enabling permissionless participation.
...
- **[Governance](data/concepts/governance.md)**: Protocols establish the rules and procedures for collective decision-making
- **[Agreements](data/concepts/agreements.md)**: Protocols formalize shared understandings about how systems operate
- **[Networks](data/concepts/networks.md)**: Protocols enable coordination across distributed networks of participants
- **[Decisions](data/concepts/decisions.md)**: Protocols structure how collective choices are made and implemented
- **[Primitives](data/concepts/primitives.md)**: Protocols are fundamental building blocks for constructing complex systems
