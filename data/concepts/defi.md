...
- [blockchain](data/concepts/blockchain.md): The underlying technology that enables decentralized, trustless financial applications
- [governance](data/concepts/governance.md): The mechanisms by which DeFi protocols make decisions and evolve
- protocols: Standardized sets of rules that govern DeFi interactions
- [payments](data/concepts/payments.md): The exchange of value between parties, transformed by DeFi mechanisms
- [privacy](data/concepts/privacy.md): A critical consideration in designing ethical DeFi systems
- [attestations](data/concepts/attestations.md): Verified statements that can enhance trust and functionality in DeFi applications