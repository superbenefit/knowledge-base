...
- **[Agreements](data/concepts/agreements.md)**: Formal commitments that establish shared expectations, with practices often emerging from agreements
- **[Protocols](data/concepts/protocols.md)**: Standardized rules that govern interactions, which practices often implement
...
- **[Roles](data/concepts/roles.md)**: Defined responsibilities that practices help coordinate
- **[Tasks](data/concepts/tasks.md)**: Specific actions guided by established practices
- **[Governance](data/concepts/governance.md)**: Systems for collective decision-making that incorporate various practices
