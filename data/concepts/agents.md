...
Agents form the fundamental building blocks of all social and technological systems. They possess varying degrees of [autonomy](data/concepts/autonomy.md), capabilities, and authority to act, make [decisions](data/concepts/decisions.md), and affect their environment. Whether human participants, autonomous teams, or computational [systems](data/concepts/systems.md), agents operate based on their incentives, knowledge, and the constraints or [permissions](data/concepts/permissions.md) granted to them within their operational context.
...
In [DAOs](data/concepts/daos.md) and web3 contexts, agents include core contributors, token holders, community members, and autonomous teams ([Cells](data/resources/patterns/cells.md)) that participate in network governance and operations. These agents interact through transparent [protocols](data/concepts/protocols.md) and operate with varying levels of [autonomy](data/concepts/autonomy.md) while remaining aligned with collective [purpose](data/concepts/purpose.md).

As described in [DAOs aren't things... they are flows](../docs/dao-primitives/articles/DAOs aren't things... they are flows..md), DAOs function as "purpose-aligned networks of small autonomous teams" where these agent-teams self-organize around opportunities while maintaining coherence within the broader network. These agents exercise their agency through mechanisms like submitting proposals, contributing to projects, participating in governance, and allocating [resources](data/concepts/resources.md).

The effectiveness of DAOs depends on creating conditions where individual agents can act autonomously while remaining aligned with collective goals—what [Building DAOs as scalable networks](../docs/dao-primitives/articles/Building DAOs as scalable networks.md) describes as "DAOs as network intelligence that flows," where resources and attention naturally orient toward the highest-value opportunities through distributed agent decisions rather than centralized direction.
...
- **Knowledge Commons Management**: Agents can help organize, synthesize, and make accessible the collective knowledge of a community through technologies like [semiotic bridging](data/concepts/semiotic-bridging.md), which translates between different knowledge systems and cultural contexts
...
- [Actions](data/concepts/actions.md): The processes or events initiated by agents that result in change
- [Roles](data/concepts/roles.md): Defined responsibilities that structure how agents participate in systems
- Permissions: Controls that determine what actions agents can take
- Autonomy: The capacity of agents to operate independently
- [Delegation](data/concepts/delegation.md): The process of transferring authority between agents
