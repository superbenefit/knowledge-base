...
ReFi enables community to design and implement their own economic systems aligned with local needs and [values](data/concepts/values.md). These applications create more equitable distribution of resources while strengthening community resilience and [autonomy](data/concepts/autonomy.md).
...
- **[DeFi](data/concepts/defi.md)**: The technical foundation upon which ReFi builds, adding regenerative principles to decentralized financial applications
- **[Protocols](data/concepts/protocols.md)**: ReFi develops standardized rule sets that enable regenerative activities to scale across networks
- **[Sustainability](data/concepts/sustainability.md)**: ReFi extends sustainability beyond harm reduction toward actively regenerative systems
- **[Community](data/concepts/community.md)**: ReFi emphasizes community governance and participation in economic systems
- **[Impact](data/concepts/impact.md)**: ReFi creates measurable, verifiable mechanisms for tracking positive environmental and social outcomes
- **[DAOs](data/concepts/daos.md)**: Governance structures that enable collective management of regenerative resources and projects
