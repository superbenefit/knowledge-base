...
- [Permissions](data/concepts/permissions.md): Systems for managing access and authority within modules
- [Protocols](data/concepts/protocols.md): Standardized rules that enable modules to interoperate
- [Platforms](data/concepts/platforms.md): Systems that host and integrate various modules