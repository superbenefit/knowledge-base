...
_Agreements are formalized understandings or commitments between parties that establish shared expectations, terms, and parameters for interaction, resource allocation, and collective action, creating a foundation for [coordination](data/concepts/coordination.md) and accountability._

Agreements serve as the connective tissue in any coordination system, enabling diverse entities to align their actions without requiring centralized control. They transform implicit assumptions into explicit commitments that can be referenced, revised, and relied upon. In [decentralized](data/concepts/decentralization.md) systems, agreements take on particular importance as they replace traditional command structures with consent-based protocols that respect the [autonomy](data/concepts/autonomy.md) of participants while ensuring coherent collective action.

The form of agreements can vary widely - from informal social norms to detailed smart contracts with automated enforcement. Regardless of their form, effective agreements balance clarity and flexibility, providing enough structure to enable confident action while allowing for adaptation as contexts change. In web3 and DAO contexts, agreements often exist across multiple layers simultaneously: as social commitments, [governance](data/concepts/governance.md) protocols, and executable code.
...
### Agreements in Web3 and [Blockchain](data/concepts/blockchain.md) Systems
...
### Agreements in [Community](data/concepts/community.md) Coordination

At the community level, agreements establish shared norms, [values](data/concepts/values.md), and practices that enable large groups to collaborate effectively. These often include:
