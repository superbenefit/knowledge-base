...
- **[Primitives](data/concepts/primitives.md)**: Fundamental building blocks that frameworks organize into coherent systems
- **Patterns**: Reusable solutions to common problems that frameworks often incorporate and contextualize
- **[Protocols](data/concepts/protocols.md)**: Standardized procedures that implement framework principles in specific domains
- **[modules](data/concepts/modules.md)**: Self-contained components that can be arranged according to framework principles
- **[Playbooks](data/concepts/playbooks.md)**: Practical guides that apply frameworks to specific implementation contexts
- **[Practices](data/concepts/practices.md)**: Regular activities and methods guided by framework principles
...
- **[DAO Primitives Framework](docs/dao-primitives/primitives-framework/concepts/index.md)**: A conceptual model for understanding and designing decentralized autonomous organizations
