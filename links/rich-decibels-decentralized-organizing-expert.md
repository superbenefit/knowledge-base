...
Rich Decibels represents a unique bridge between traditional [community](tags/community.md) [organizing](tags/organizing.md) and emerging [decentralized](tags/decentralization.md) [governance](tags/governance.md) models. As co-founder of Loomio (collaborative [decision-making](tags/decision-making.md) software), Enspiral (a self-managing collective), Microsolidarity (mutual-aid community [networks](tags/networks.md)), and The Hum (organizational design consultancy), Richard D. Bartlett has spent over a decade developing practical frameworks for non-hierarchical [coordination](tags/coordination.md). His work stands out in the decentralized space for its emphasis on social dynamics and lived experience rather than purely technical solutions, offering seasoned wisdom about the human challenges that arise when groups attempt to organize without traditional power structures.
...
- **Hospitality as Sacred Practice**: Through Casa Tilo retreat center, Rich explores how intentional hospitality and gathering practices create the social foundation necessary for effective [collaboration](tags/collaboration.md), treating relationship-building as infrastructure rather than byproduct.
...
- [DAOs](tags/daos.md) and web3 projects can learn from his experience with digital-first coordination to understand how technical governance tools interact with social dynamics, avoiding common pitfalls around tokenized voting and community management
...
- His pattern-based organizational design methodology resonates with SuperBenefit's work on group state [primitives](tags/primitives.md) and reusable coordination frameworks.
