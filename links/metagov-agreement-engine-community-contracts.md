...
- [DAOs](tags/daos.md) can implement [governance](tags/governance.md) agreements about decision-making processes that participants commit to follow, making procedural norms enforceable while retaining collective capacity to amend processes
...
- Metagov's Agreement Engine provides infrastructure for the middle ground SuperBenefit navigates between informal coordination and rigid technical automation—demonstrating how coordination [primitives](tags/primitives.md) can enable accountability while preserving human judgment and collective amendment capacity rather than forcing choice between unenforced social norms or immutable code.
