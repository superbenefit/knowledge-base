...
- **[Link Evaluation](tools/workflows/library/link-evaluation-workflow.md)**: Rigorous triple-gate process for assessing resource alignment, quality, and uniqueness
- **[Link Creation](tools/workflows/library/link-creation-workflow.md)**: Guidelines for creating standardized library entries that reflect SuperBenefit's perspective
- **[Discord Mining](tools/workflows/library/discord-mining-workflow.md)**: Systematic process for discovering and analyzing community-shared resources
