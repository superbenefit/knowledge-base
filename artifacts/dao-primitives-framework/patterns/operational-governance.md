...
- **[Community governance](artifacts/dao-primitives-framework/patterns/community-governance.md)**: Strategic oversight complementing operational execution  
- **[Group state](artifacts/dao-primitives-framework/patterns/group-state.md)**: Transparency mechanisms enabling coordination
