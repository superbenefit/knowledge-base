...
- **Wrapping Smaller Scales**: Usually constituency scale [governance](tags/governance.md) will wrap smaller scale operational structures. For example, it will act as the [community](tags/community.md) governance wrapper that will support [coordination-scale](artifacts/dao-primitives-framework/group-scale/coordination-scale.md) and [collaboration-scale](artifacts/dao-primitives-framework/group-scale/collaboration-scale.md) scale operational groups.
...
- [group-state](artifacts/dao-primitives-framework/patterns/group-state.md)
- [artifacts/dao-primitives-framework/patterns/community-governance](artifacts/dao-primitives-framework/patterns/community-governance.md)
- [artifacts/dao-primitives-framework/dao-primitives-implemention/implementation-guide-community-governance](artifacts/dao-primitives-framework/dao-primitives-implemention/implementation-guide-community-governance.md)
- [daos](artifacts/dao-primitives-framework/group-primitives/daos.md)
