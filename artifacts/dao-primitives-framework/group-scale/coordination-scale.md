...
- **Group State**: Using onchain trust mechanisms that connect back to [group state](artifacts/dao-primitives-framework/patterns/group-state.md) documentation allow groups to participate in coordination scale structures without overwhelming the coordination overhead.
...
- Effective mechanisms for engaging with [constituency-scale](artifacts/dao-primitives-framework/group-scale/constituency-scale.md) and [network](tags/networks.md) scales.
