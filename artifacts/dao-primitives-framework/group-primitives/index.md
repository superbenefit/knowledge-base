...
- [Cells (Primitive)](artifacts/dao-primitives-framework/group-primitives/cells.md)
- [DAOs (Primitive)](artifacts/dao-primitives-framework/group-primitives/daos.md)
- [Roles (Primitive)](artifacts/dao-primitives-framework/group-primitives/roles.md)
- [Tasks (Primitive)](artifacts/dao-primitives-framework/group-primitives/tasks.md)
...
The [primitives](tags/primitives.md) are designed to evolve through the different stages of [index](artifacts/dao-primitives-framework/group-phase/index.md) and also deliver on different [index](artifacts/dao-primitives-framework/group-scale/index.md) requirements of the [governance](tags/governance.md) and operational system being designed.
...
- *[Cells (Primitive)](artifacts/dao-primitives-framework/group-primitives/cells.md)DAOs (Primitive)) (PRoles (Primitive)s/dao-primitives/dao-primitives-framework/group-primitives/tasks|Tasks (Primitive)]]
