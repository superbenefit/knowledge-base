...
**[Governance](tags/governance.md) [Primitives](tags/primitives.md)**: In the DAO Primitives Framework, DAOs utilize the other 3 [index](artifacts/dao-primitives-framework/group-primitives/index.md) to implement their governance and operational design:

- [Cells](artifacts/dao-primitives-framework/group-primitives/cells.md) - The autonomous teams that comprise DAO networks
- [Roles](artifacts/dao-primitives-framework/group-primitives/roles.md) - Specialized functions within DAO coordination systems
- [Tasks](artifacts/dao-primitives-framework/group-primitives/tasks.md) - Coordinated actions across DAO networks
...
**RPP [Governance](tags/governance.md)**: This project is a good example of how a larger DAO structure (SuperBenefit) can support multi-stakeholder partnerships within its broad [community](tags/community.md) governance umbrella. This shows how complex governance and operations can be made simple and effective while maintaining appropriate levels of high-level governance. See [artifacts/dao-primitives-framework/rpp-governance-case-study](artifacts/dao-primitives-framework/rpp-governance-case-study.md)
...
- [Group State](artifacts/dao-primitives-framework/patterns/group-state.md) - The transparency framework that enables DAO coordination
