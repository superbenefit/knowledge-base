...
When the Coordination phase is complete, a group may either evolve into a [governance](tags/governance.md) or operational structure or enter a [completion phase](artifacts/dao-primitives-framework/group-phase/completion-phase.md) as its [purpose](tags/purpose.md) is fulfilled.
...
The activities of a Coordination phase group are outlined in their [group state](artifacts/dao-primitives-framework/patterns/group-state.md) documentation. Broadly these include:
...
- **Knowledge Sharing:** Documenting and sharing learnings, tools, and approaches that could benefit others in the [network](tags/networks.md). Including consistently updating and sharing its [group state](artifacts/dao-primitives-framework/patterns/group-state.md) documentation.
