...
The Organization phase is complete when the structure outlined in the group's [group-state](artifacts/dao-primitives-framework/patterns/group-state.md) documentation has been fully implemented, [roles](tags/roles.md) have been filled, and the group is executing on its goals.
...
- **Robust State Documentation:** Fully developed [group-state](artifacts/dao-primitives-framework/patterns/group-state.md) document that provides [transparency](tags/transparency.md) about [purpose](tags/purpose.md), [practices](tags/practices.md), and [progress](tags/progress.md).
...
Activities revolve around implementing the [governance](tags/governance.md) and operational design proposed in the group's [group-state](artifacts/dao-primitives-framework/patterns/group-state.md) documentation and approved by the [community](tags/community.md) or governance system proposal process used.
...
An organization phase group may be ready to evolve to the ongoing [coordination phase](artifacts/dao-primitives-framework/group-phase/coordination-phase.md) when:
...
- The group's [group-state](artifacts/dao-primitives-framework/patterns/group-state.md) documentation is comprehensive and regularly maintained
