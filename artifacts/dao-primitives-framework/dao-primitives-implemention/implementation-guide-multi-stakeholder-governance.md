...
2. Design a governance structure using the [DAO primitives framework](artifacts/dao-primitives-framework/dao-primitives-concepts.md)
...
Using the [DAO primitives framework](artifacts/dao-primitives-framework/dao-primitives-concepts.md) to create a purpose aligned network of small autonomous teams, we utilize 3 distinct and interlocking systems of governance:
