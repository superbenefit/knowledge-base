...
```mermaid
graph TD
    A[Commitment to Accountability Breach] --> B[Conflict Recognition]
    B --> C[Interpersonal Discourse]
    C -->|Resolved| D[Resolution]
    C -->|Not Resolved| E[Mediation - optional]
    E -->|Resolved| D
    E -->|Not Resolved| F[Arbitration - optional]
    F --> D
    D --> G[Follow-up & Learning]
```
 %%
---
...
## Step 3: Conflict Mediation <sup>(optional)</sup>
...
## Step 4: Conflict Arbitration <sup>(optional)</sup>
