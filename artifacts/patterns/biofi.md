...
The BioFi movement has a special power and salience in a period of escalating environmental collapse, institutional transition and technological peril known as the [polycrisis](). As large pools of capital are being mobilized to address these emergencies, activists, scholars and community members have long drawn attention to the danger that this institutional capital deploy along the same channels and within the same frameworks that instigated this polycrisis in the first place. **The BioFI Project** has crystallized these concerns into an actionable language for capital allocation along lines that honor the dramatic contextual diversity of the threats to living systems we are facing today. 
