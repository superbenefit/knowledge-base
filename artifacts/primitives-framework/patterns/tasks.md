...
**Complementary to Roles**: Tasks work in conjunction with [Roles](artifacts/primitives-framework/patterns/roles.md) to operationalize network [coordination](tags/coordination.md) - [Roles](artifacts/primitives-framework/patterns/roles.md) defining "who" has [responsibility](tags/responsibilities.md) and [authority](tags/authorities.md), while Tasks define "what" specific [actions](tags/actions.md) and deliverables need to be accomplished.

**Distributed Execution**: Tasks enable coordinated [action](tags/actions.md) across network entities while preserving [autonomy](tags/autonomy.md) in how work is accomplished, creating structured workflows that can operate across multiple [Cells](artifacts/primitives-framework/patterns/cells.md) and contexts.

## Task State

**Task State** documentation enables Tasks to function effectively as [agreements](tags/agreements.md) primitives across [DAO networks](artifacts/primitives-framework/patterns/daos.md). Each Task maintains transparent state documentation that captures the essential information needed for both task execution and network [coordination](tags/coordination.md).

This [transparent](tags/transparency.md) task state makes tasks addressable and understandable across the wider network, not just internally to the [entity](artifacts/primitives-framework/patterns/cells.md) that created them. By documenting task state in accessible formats, other [Cells](artifacts/primitives-framework/patterns/cells.md), [Roles](artifacts/primitives-framework/patterns/roles.md), and network participants can discover, understand, and coordinate with ongoing work directly, enabling the distributed execution that characterizes effective [DAO](artifacts/primitives-framework/patterns/daos.md) networks.
...
**Entity-Task Integration**: Tasks provide the operational interfaces between [Cells](artifacts/primitives-framework/patterns/cells.md) and [DAOs](artifacts/primitives-framework/patterns/daos.md), enabling entities to coordinate work effectively by establishing clear [agreements](tags/agreements.md) about specific deliverables, timelines, and [accountability](tags/accountability.md) across the network.

**Role-Task Coordination**: Tasks work closely with [Roles](artifacts/primitives-framework/patterns/roles.md) to operationalize network activity - [Roles](artifacts/primitives-framework/patterns/roles.md) defining "who" has [responsibility](tags/responsibilities.md) and [authority](tags/authorities.md), while Tasks define "what" specific [actions](tags/actions.md) and deliverables need to be accomplished to advance network [purpose](tags/purpose.md).
...
**Cell-Internal Tasks**: [Cells](artifacts/primitives-framework/patterns/cells.md) coordinate internal tasks to manage their operational activities and deliverables while maintaining clear interfaces about their work with other Cells and the broader network.

**Cross-Cell Task Workflows**: Tasks that span multiple [Cells](artifacts/primitives-framework/patterns/cells.md) or require coordination between different network entities, enabling complex workflows without hierarchical project management structures.

**Contributor Coordination Tasks**: Tasks used by [Cells](artifacts/primitives-framework/patterns/cells.md) to engage external contributors, often working in conjunction with [Roles](artifacts/primitives-framework/patterns/roles.md) to create clear [agreements](tags/agreements.md) about specific contributions and deliverables.

**Network-Level Initiatives**: Tasks that coordinate activities across the broader [DAO](artifacts/primitives-framework/patterns/daos.md) network, enabling collective action on shared objectives while preserving entity [autonomy](tags/autonomy.md) in execution approaches.
...
- [Roles](artifacts/primitives-framework/patterns/roles.md) - The complementary agreements primitive that defines "who"
- [Cells](artifacts/primitives-framework/patterns/cells.md) - Entities that coordinate and execute tasks
- [DAOs](artifacts/primitives-framework/patterns/daos.md) - Network entities that enable task coordination
