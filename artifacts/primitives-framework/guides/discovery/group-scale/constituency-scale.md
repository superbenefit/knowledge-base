...
Constituency Scale represents hundreds to millions of stakeholders who share common interests, emphasizing participation, representation, and collective [decision-making](tags/decisions.md) across a wider [community](tags/community.md) than [Collaboration](artifacts/primitives-framework/guides/discovery/group-scale/collaboration-scale.md) or [Coordination](artifacts/primitives-framework/guides/discovery/group-scale/coordination-scale.md) scales.
...
- [artifacts/primitives-framework/guides/implementation/implementation-guide-community-governance](artifacts/primitives-framework/guides/implementation/implementation-guide-community-governance.md)
- [daos](tags/daos.md)
