...
Network Scale represents relationships and connections between multiple decentralized organizations and [communities](tags/community.md) coordinating across [Collaboration](artifacts/primitives-framework/guides/discovery/group-scale/collaboration-scale.md), [Coordination](artifacts/primitives-framework/guides/discovery/group-scale/coordination-scale.md), and [Constituency](artifacts/primitives-framework/guides/discovery/group-scale/constituency-scale.md) scales to achieve shared impact.
...
- Clear [group-state](artifacts/primitives-framework/guides/design/group-state.md) documentation from all entities enables alignment and trust
...
- **Multi-Scale:** The network is operationalized through interdependent entities that operate at different [group-scales](artifacts/primitives-framework/guides/discovery/group-scale/index.md), in order to most effectively deliver on the goals of the network.
