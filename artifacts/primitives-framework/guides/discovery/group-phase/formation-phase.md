...
The Formation Phase marks the transition from exploration to structured commitment. Following the [Conversation Phase](artifacts/primitives-framework/guides/discovery/group-phase/conversation-phase.md), groups establish clear boundaries, formalize [agreements](tags/agreements.md), and design the structure needed for coordinated action. Complete this phase by preparing a proposal for resources, funding, or formal recognition.

Move to [Organization Phase](artifacts/primitives-framework/guides/discovery/group-phase/organization-phase.md) when the proposal is approved and the group is ready to implement formal structure.

## Key Characteristics

- **Purpose Definition:** The group works from the clear, specific purpose statement that emerged in the [conversation-phase](artifacts/primitives-framework/guides/discovery/group-phase/conversation-phase.md) phase. This defines its reason for existence and intended contribution to the broader network.
...
- **[Governance](tags/governance.md) & Operational Design:** Designing the governance and operational structure that will be implemented in the [organization-phase](artifacts/primitives-framework/guides/discovery/group-phase/organization-phase.md) phase.
...
- **Initial State Documentation:** Documenting the group's proposed purpose, practices, and plans in a [group-state](artifacts/primitives-framework/guides/design/group-state.md) document. This outlines vision and practical implementation of the group.
...
A formation phase group may be ready to evolve to a more structured [organization phase](artifacts/primitives-framework/guides/discovery/group-phase/organization-phase.md) when:
...
- The group's [group state](artifacts/primitives-framework/guides/design/group-state.md) document is sufficiently developed to outline the structure to be implemented in the organization phase.
...
Creating a lightweight but clear [group state](artifacts/primitives-framework/guides/design/group-state.md) document is a critical practice during the Formation Phase.
