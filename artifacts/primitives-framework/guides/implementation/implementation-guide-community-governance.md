...
Design and implement [constituency-scale](tags/groups.md#groups-at-different-scales) community [governance](tags/governance.md) that safeguards network purpose, steers long-term evolution, and enables genuine community participation. [DAOs](tags/daos.md) function as purpose-aligned networks through decentralized coordination mechanisms rather than rigid hierarchies.

Use the [DAO Primitives framework](artifacts/primitives-framework/guides/concepts.md) to compose governance from fundamental building blocks (primitives), creating customized structures aligned with your community's needs and [values](artifacts/primitives-framework/guides/discovery/group-values.md).

### Related Implementation Guides

Community Governance works as part of an interlocking three-layer system, or independently with alternative operational models:
...
- [Multi-Stakeholder Governance](artifacts/primitives-framework/guides/implementation/implementation-guide-multi-stakeholder-governance.md) - Network-scale partnerships
- Community Governance (this guide) - Constituency-scale foundation

> **Note**: This guide follows the [facilitation process](artifacts/primitives-framework/guides/index.md) structure. Complete discovery phase before beginning. Consider engaging an experienced facilitator for support.
...
Follow this process to design and implement community governance:

1. Understand core concepts of DAO community governance
