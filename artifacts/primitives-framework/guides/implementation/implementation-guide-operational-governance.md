...
Design and implement [coordination-scale](artifacts/primitives-framework/guides/discovery/group-scale/coordination-scale.md) operational [governance](tags/governance.md) for decentralized execution and delivery. Use [primitives](tags/primitives.md) and patterns to create flexible, adaptable organizational structures that enable autonomous teams while maintaining alignment with broader goals.

Use the [DAO Primitives framework](artifacts/primitives-framework/guides/concepts.md) to compose operational structures from fundamental building blocks, creating systems tailored to your network's needs.

### Related Implementation Guides

Operational Governance works as part of an interlocking three-layer system, or independently with alternative community governance models:

- Operational Governance (this guide) - Coordination-scale execution
...
> **Note**: This guide follows the [facilitation process](artifacts/primitives-framework/guides/index.md) structure. Ensure community governance establishes core network purpose and high-level goals before beginning operational design. Consider engaging an experienced facilitator for support.
