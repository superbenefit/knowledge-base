...
In early [conversation-phase](artifacts/dao-primitives-framework/group-phase/conversation-phase.md) and [formation-phase](artifacts/dao-primitives-framework/group-phase/formation-phase.md) phases, a team's nucleus may be an informal emerging set of agreements. However as a team becomes established ( through [organization-phase](artifacts/dao-primitives-framework/group-phase/organization-phase.md) and [coordination-phase](artifacts/dao-primitives-framework/group-phase/coordination-phase.md) phases), ideally its nucleus should have several technical qualities:
