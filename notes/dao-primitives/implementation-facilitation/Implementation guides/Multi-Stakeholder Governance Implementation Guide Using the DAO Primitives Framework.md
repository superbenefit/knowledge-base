...
5. Document core information in a [Cell state](notes/dao-primitives/patterns/cell-state.md)
...
Guidlines on what should go into a state document can be found in the [cell state template](notes/dao-primitives/patterns/cell-state-template.md) and [cell state pattern](notes/dao-primitives/patterns/cell-state.md).
