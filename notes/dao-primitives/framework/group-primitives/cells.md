...
**Multi-Scale Operation**: Cells operate internally at [[notes/dao-primitives/framework/group-scale/collaboration|collaboration scale]] within their core team (high-bandwidth communication among fewer than 10 people) while simultaneously operating at [[notes/dao-primitives/framework/group-scale/coordination|coordination scale]] as they coordinate with contributors, partners, and the larger [[notes/dao-primitives/framework/group-primitives/daos|DAO network]]. This dual-scale capability enables both intimate collaboration and broader network coordination.
...
**Cell Formation Patterns**: The cell-working-group pattern identifies four primary ways new Cells form within [[notes/dao-primitives/framework/group-primitives/daos|DAO networks]], each with different implications for how the Cell develops through the [[notes/dao-primitives/framework/group-phase/group-phase|group phases]]:
...
- **Permissionless Formation**: Groups within a [[notes/dao-primitives/framework/group-primitives/daos|DAO]] or network form Cells without requiring approval, demonstrating value through trusted [[tags/governance|governance]] and effective execution
...
- [[notes/dao-primitives/framework/group-primitives/daos|DAOs]] - The network context within which Cells operate
- [[notes/dao-primitives/framework/group-primitives/roles|Roles]] - Specialized functions within Cell structures
- [[notes/dao-primitives/framework/group-primitives/tasks|Tasks]] - Coordinated actions within and between Cells
