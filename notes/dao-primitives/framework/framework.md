...
- [Group Facilitation Guide](notes/dao-primitives/implementation-facilitation/group-facilitation.md)
...
This section provides a high-level overview of the Group Facilitation Framework. For a detailed guide to using the framework, please refer to the comprehensive documentation: [Group Facilitation Framework](notes/dao-primitives/implementation-facilitation/group-facilitation.md).
...
For a detailed explanation of the Group Facilitation Framework, including step-by-step guidance and practical examples, please refer to the complete documentation: [Group Facilitation Framework](notes/dao-primitives/implementation-facilitation/group-facilitation.md).
...
1.  **Assess Your Context:** Use the Group Facilitation Framework ([Learn more](notes/dao-primitives/implementation-facilitation/group-facilitation.md)) to determine your group's current phase and scale. This assessment will highlight the challenges you face and the types of solutions you need.
