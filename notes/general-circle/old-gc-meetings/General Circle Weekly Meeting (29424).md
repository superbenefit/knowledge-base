...
- SAFE tokens are unlocked and can be claimed - worth $3500USD currently - 200 SAFE Tokens that SB received, we got these from using the gnosis safe 

- Windfall Protocol report released by Blockscience today - 

 The Windfall Protocol: Blockchain-Based Infrastructure to Accelerate Building Retrofits & Energy Efficiency Initiatives

 ,https://blog.block.science/the-windfall-protocol/
