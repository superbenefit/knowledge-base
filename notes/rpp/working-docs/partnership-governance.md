...
This pattern is for creating a fractal of a community and operational [governance](tags/governance.md) (a DAO within a DAO). Creating a functioning [community governance](notes/rpp/working-docs/community-governance.md) (stakeholder group) and a Cell-based operational network execute on the goals of the stakeholders.
